...
class CityZipGeonamesImport(models.TransientModel):
    ...
    def get_and_parse_csv(self, country):
        ...
        if res_request.status_code != requests.codes.ok:
            # pylint: disable=translation-positional-used - Don't want to
            # re-translate
            raise UserError(
    ...
    def _create_cities(
        ...
        # pylint: disable=context-overridden - It's legit to replace it in this
        # case
    ...
    def _process_csv(self, parsed_csv, country):
        ...
        state_dict = self._create_states(
